...
{
    resize(850+95, 550);
    setWindowTitle(tr("FutureCoin1") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    int id = QFontDatabase::addApplicationFont(":/fonts/comicsans");
    QString family = QFontDatabase::applicationFontFamilies(id).at(0);
    QFont::insertSubstitution("Comic Sans MS", "LDFComicSans");
    QFont appFont("Comic Sans MS", 14);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a FutureCoin1 address"));
    ...
    aboutAction = new QAction(tr("&About FutureCoin1"), this);
    aboutAction->setToolTip(tr("Show information about FutureCoin1"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for FutureCoin1"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("FutureCoin1 client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("FutureCoin1 client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FutureCoin1 network", "", count));
}
...
{
    QString strTitle = tr("FutureCoin1") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid FutureCoin1 address or malformed URI parameters."));
    }
