...
class FormatIterator {
   public:
    ...
    enum ExtraFormatFlags {
        ...
        Flag_TruncateToPrecision =
            1 << 0,  // truncate length to stream precision()
   ...
   private:
    ...
    // returns false)
    template <typename T>
    static bool formatCStringTruncate(std::ostream & /*out*/,
                                      const T & /*value*/,
...
inline const char *FormatIterator::streamStateFromFormat(
    std::ostream &out, unsigned int &extraFlags, const char *fmtStart,
...
// We enforce a mimimum of one value to be formatted to prevent bugs looking
// like
//
...
#define TINYFORMAT_WRAP_FORMAT_N(n, returnType, funcName, funcDeclSuffix,  \
    ...
    returnType funcName(TINYFORMAT_WRAP_FORMAT_EXTRA_ARGS const char *fmt, \
        ...
        bodyPrefix tinyformat::format(streamName, fmt,                     \
...
#define TINYFORMAT_WRAP_FORMAT(returnType, funcName, funcDeclSuffix,        \
    ...
    inline returnType funcName(                                             \
        TINYFORMAT_WRAP_FORMAT_EXTRA_ARGS const char *fmt) funcDeclSuffix { \
        bodyPrefix tinyformat::detail::FormatIterator(streamName, fmt)      \
            .finish();                                                      \
        bodySuffix                                                          \
    }                                                                       \
    TINYFORMAT_WRAP_FORMAT_N(1, returnType, funcName, funcDeclSuffix,       \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(2, returnType, funcName, funcDeclSuffix,       \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(3, returnType, funcName, funcDeclSuffix,       \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(4, returnType, funcName, funcDeclSuffix,       \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(5, returnType, funcName, funcDeclSuffix,       \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(6, returnType, funcName, funcDeclSuffix,       \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(7, returnType, funcName, funcDeclSuffix,       \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(8, returnType, funcName, funcDeclSuffix,       \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(9, returnType, funcName, funcDeclSuffix,       \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(10, returnType, funcName, funcDeclSuffix,      \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(11, returnType, funcName, funcDeclSuffix,      \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(12, returnType, funcName, funcDeclSuffix,      \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(13, returnType, funcName, funcDeclSuffix,      \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(14, returnType, funcName, funcDeclSuffix,      \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(15, returnType, funcName, funcDeclSuffix,      \
                             bodyPrefix, streamName, bodySuffix)            \
    TINYFORMAT_WRAP_FORMAT_N(16, returnType, funcName, funcDeclSuffix,      \
                             bodyPrefix, streamName, bodySuffix)
