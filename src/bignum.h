...
class CBigNum : public BIGNUM {
    ...
    */
     ...
     * @return the size
     */
    int bitSize() const { return BN_num_bits(this); }
    ...
    unsigned long getulong() const { return BN_get_word(this); }

    unsigned int getuint() const { return BN_get_word(this); }
    ...
    uint64_t getuint64() {
        ...
        uint64_t n = 0;
        for (unsigned int i = 0, j = vch.size() - 1; i < sizeof(n) && j >= 4;
             i++, j--)
    ...
    */
     ...
     * @return the prime
     */
    static CBigNum generatePrime(const unsigned int numBits,
                                 bool safe = false) {
        CBigNum ret;
        if (!BN_generate_prime_ex(&ret, numBits, (safe == true), NULL, NULL,
                                  NULL))
            throw bignum_error(
    ...
    */
    ...
    bool isOne() const { return BN_is_one(this); }

    bool operator!() const { return BN_is_zero(this); }
