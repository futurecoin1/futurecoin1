...
class CPubKey {
   ...
   public:
    ...
    bool Derive(CPubKey &pubkeyChild, unsigned char ccChild[32],
                unsigned int nChild, const unsigned char cc[32]) const;
};
...
class CKey {
   ...
   public:
    ...
    static bool CheckSignatureElement(const unsigned char *vch, int len,
                                      bool half);
};
